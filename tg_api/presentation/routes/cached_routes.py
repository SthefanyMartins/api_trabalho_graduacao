...
async def get_states_count_by_region(dependencies=Depends(application_container)):
    result_from_cache = await dependencies.cache_repository.get_states_count_by_region()
    if result_from_cache:
        return result_from_cache

    states = await dependencies.queries_repository.states_count_by_region()
    await dependencies.cache_repository.set_states_count_by_region(states)
...
async def get_schools_with_restricted_services_by_municipalities(
    ...
    result_from_cache = (
        await dependencies.cache_repository.get_schools_with_restricted_services_by_municipalities(page)
    )
    if result_from_cache:
        return result_from_cache
    ...
    await dependencies.cache_repository.set_schools_with_restricted_services_by_municipalities(
        page,
        schools
    )
...
async def get_private_high_schools_by_region(
    ...
    result_from_cache = (
        await dependencies.cache_repository.get_private_high_schools_by_region(page)
    )
    if result_from_cache:
        return result_from_cache
    ...
    await dependencies.cache_repository.set_private_high_schools_by_region(
        page,
        schools
    )
...
async def get_average_number_of_schools_per_city_in_region(
    ...
    result_from_cache = (
        await dependencies.cache_repository.get_average_number_of_schools_per_city_in_region()
    )
    if result_from_cache:
        return result_from_cache
    ...
    await dependencies.cache_repository.set_average_number_of_schools_per_city_in_region(
        regions
    )
...
async def get_city_with_the_largest_number_of_higher_education_school(
    ...
    result_from_cache = (
        await dependencies.cache_repository.get_city_with_the_largest_number_of_higher_education_school()
    )
    if result_from_cache:
        return result_from_cache
    ...
    await dependencies.cache_repository.set_city_with_the_largest_number_of_higher_education_school(
        cities
    )
...
async def get_state_with_concentration_of_private_elementary_schools(
    ...
    result_from_cache = (
        await dependencies.cache_repository.get_state_with_concentration_of_private_elementary_schools()
    )
    if result_from_cache:
        return result_from_cache
    ...
    await dependencies.cache_repository.set_state_with_concentration_of_private_elementary_schools(
        states
    )
...
async def get_number_of_higher_education_schools_in_each_city(
    ...
    result_from_cache = (
        await dependencies.cache_repository.get_number_of_higher_education_schools_in_each_city(page)
    )
    if result_from_cache:
        return result_from_cache
    ...
    await dependencies.cache_repository.set_number_of_higher_education_schools_in_each_city(
        page,
        cities
    )
